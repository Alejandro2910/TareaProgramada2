...
class GrafoDir_MA
{
    public:
        ...
        */
        ...
        /**
        * @brief Operador basico que agrega una arista conectanto el vertice v1 al vertice v2 con el valor de su peso.
        ...
        */
        ...
        /**
        * @brief Operador basico que elimina la arista conectanto el vertice v1 al vertice v2.
        * @param Int v1, Int v2.
        */
        ...
        */
        ...
        /**
        * @brief Operador basico que permite modificar el peso de la arista que conecta a vertice v1, con el vertice v2.
        ...
        */
        ...
        /**
        * @brief Operador basico que verifica que exista la arista que conecta a el vertice v1 al vertice v2.
        * @param Int v1, Int v2.
